...
public class RenowalkModules {
	...
	public static final String Common_BtnSorting_xp = "//th[text()='Last Activity ']/span[@title='Sort' and @class='glyphicon glyphicon-sort clickable']";
	public static final String Common_BtnSorting_County_xp = "//th[text()='County ']/span[@title='Sort' and @class='glyphicon glyphicon-sort clickable']";
	public static final String Common_BtnSorting_LastActivity_xp = "//th[text()='Last Activity ']/span[@title='Sort' and @class='glyphicon glyphicon-sort clickable']";
	...
	//public static final String Common_AddModule_BtnDialogBox = "//div[@class='confirmSaveContent']/button[@class='btn btn-default closeButtonOk']";
	 ...
	 //public static final String Common_AddModule_TextDialogBox = "//div[@class='uibDialogMessage text-center ng-binding ng-scope']";
	public static final String Common_AddModule_TextDialogBox = "//div[contains(@class,'uibDialogMessage text-center ng-binding ng-scope')]"; //Changed to handle delete user  
	 public static final String Common_AddModule_BtnDialogBox = "//button[@class='btn btn-default uibDialogOk ng-binding ng-scope' and @ng-click='ok()']";
	 ...
	 public static final String Common_CancelModule_BtnYes = "//button[@class='btn btn-default uibDialogOk ng-binding ng-scope' and text()='Yes']";
	 public static final String Common_CancelModule_BtnNo = "//button[@class='btn btn-warning uibDialogCancel ng-binding ng-scope' and text()='No']";
	...
	//By class
	public static final String Property_IH_loadingimage_Class =  "loadingDivGif";  // page loading Icon
	public static final String Property_IH_loadingmessage_Class = "loadingDivText";  //Page loading message
	...
	public static final String Property_ViewProperty_id = "listTable";
	
	
	public static final String Property_GenProperty_LinkPropertyOption_xp = "//a[text()= ' Property ']"; 
	public static final String Offices_ViewProperty_LabelCurrentProperties_xp = "//h3[text()= 'Properties']";
	 ...
	 public static final String Property_AddProperty_InputPropertyCode_xp="//input[@name='PropertyCode' and @type='text']";
	 ...
	 public static final String Property_AddProperty_PropertyStatus_xp = "//select[@name='PropertyStatus']";
	 ...
	 public static final String Property_AddProperty_DueDate_xp = "//input[@datepicker-popup='M/d/yyyy']";
	 ...
	 public static final String Property_AddProperty_NumberBedroomErrorMsgRequired_xp = "//div[@class='errorMessage' and @ng-show='addForm.NumberBedroom.$error.number']";
	...
	public static final String Property_SearchProperty_FirstCheckBox_xp = "//tr[1]/td[@class='ng-valid ng-dirty ng-valid-parse ng-touched'][8]";
	...
	public static final String Property_ViewProperty_BulkDeleteCheckBx_xp = "//input[@class='ng-pristine ng-untouched ng-valid' and @type='checkbox']";
	

	public static final String Property_SearchProperty_BtnDeleteSelected_xp = "//*[@id='selectedDeleteBtn']";
	...
	public static final String Property_EditProperty_CommonTable_xp = "//div[@class='propertyTabContent ng-scope']";
	public static final String Property_PropertyTab_xp="//a[text()= 'Property']";
	public static final String Property_AdditionalInformation_xp="//a[text()= 'Additional Information']";
	public static final String Property_PropertyWalk_xp="//a[text()= 'Property Walk']";
	public static final String Property_Budget_xp="//a[text()= 'Budget']";
	public static final String Property_ProjectTools_xp="//a[text()= 'Project Tools']";	
	public static final String Property_ActivityLog_xp="//a[text()= 'Activity Log']";
	public static final String Property_VerifyAddress_ProjectName_xp="//span[@ng-bind='editObject.ProjectName']";
	public static final String Property_VerifyAddress_xp="//span[@ng-bind='editObject.Address']";
	public static final String Property_VerifyCity_xp="//span[@ng-bind='editObject.City']";
	public static final String Property_VerifyState_xp="//span[@ng-bind='editObject.State']";
	public static final String Property_VerifyZipcode_xp="//span[@ng-bind='editObject.ZipCode']";
	public static final String Property_clickProperty_XP="//b[contains(text(),'propertNameToBeclicked')]"; //replace property name in actual code
	public static final String Property_IH_PTL_xp="//a[text()= 'IH PTL']";
	public static final String Property_IH_Budget_xp="//a[text()= 'IH Budget']";
	public static final String Property_TenantResponsible_xp="//a[text()= 'Tenant Responsible']";
	//disabled project tools buttons
	public static final String Property_ProjectTools_ExportCSV_Disabled_xp="//button[@disabled='disabled' and text()='Export CSV']";
	public static final String Property_ProjectTools_PDF_Disabled_xp="//button[@disabled='disabled' and text()='PDF']";
	public static final String Property_ProjectTools_PTLFinalized_Disabled_xp="//button[@disabled='disabled' and text()='PTL Finalized']";
	public static final String Property_ProjectTools_Property_GeneratePTLSpreadsheet_Disabled_xp="//button[@disabled='disabled' and text()='Generate PTL Spreadsheet']";
	
	//enabled project tools buttons	
	public static final String Property_ProjectTools_ExportCSV_XP="//button[not(contains(@disabled,'disabled')) and text()='Export CSV']";
	public static final String Property_ProjectTools_PDF_XP="//button[not(contains(@disabled,'disabled')) and text()='PDF']";
	public static final String Property_ProjectTools_PTLFinalized_XP="//button[not(contains(@disabled,'disabled')) and text()='PTL Finalized']";
	public static final String Property_ProjectTools_GeneratePTLSpreadshoot_XP="//button[not(contains(@disabled,'disabled')) and text()='Generate PTL Spreadsheet']";
	public static final String Property_ProjectTools_AssignSalesforce_xp="//button[not(contains(@disabled,'disabled')) and text()='Assign Salesforce']";
	
	
	public static final String Property_PropertyStatus_InProperty_XP="//span[@ng-bind='editObject.PropertyStatus']";
	public static final String Property_PropertyWalk_CreateNewWalk_xp="//button[@type='button' and text()='CREATE NEW WALK']";
	public static final String Property_PropertyWalk_SetWalk_id="setWalkedBtn";
	public static final String Property_ProjectTools_GeneratePTLSpreadSheet_xp="//button[@type='button' and text()='Generate PTL Spreadsheet']";
	public static final String Property_Disabled_AddProperty_Button="//button[@disabled='disabled' and @id='addToggleBtn']";
	public static final String Property_Disabled_ProjectName_textbox="//input[@disabled='disabled' and @name='ProjectName']";
	
	public static final String Property_Disabled_Propertycode_textbox="//input[@disabled='disabled' and @name='PropertyCode']";
	public static final String Property_Disabled_Address_textbox="//input[@disabled='disabled' and @name='Address']";
	public static final String Property_Disabled_City_textbox="//input[@disabled='disabled' and @name='City']";
	public static final String Property_Disabled_State_textbox="//input[@disabled='disabled' and @name='State']";
	public static final String Property_Disabled_Zipcode_textbox="//input[@disabled='disabled' and @name='ZipCode']";
	public static final String Property_Disabled_County_textbox="//input[@disabled='disabled' and @name='County']";
	public static final String Property_Disabled_MainSqFt_textbox="//input[@disabled='disabled' and @name='MainSqFt']";
	public static final String Property_Disabled_NoOfbedRooms_textbox="//input[@disabled='disabled' and @name='NumberBedroom']";
	public static final String Property_Disabled_NoOfBathRooms_combo="//select[@disabled='disabled' and @name='NumberBathroom']";
	public static final String Property_Disabled_YearBuilt_textbox="//input[@disabled='disabled' and @name='YearBuilt']";
	public static final String Property_Disabled_Comments_textbox="//textarea[@disabled='disabled' and @name='Comment']";
	public static final String Property_Disabled_WalkAssigned_Combo="//select[@disabled='disabled' and @name='walkUserAssigned']";
	public static final String Property_Disabled_PropertyStatus_Combo="//select[@disabled='disabled' and @name='PropertyStatus']";
	public static final String Property_Disabled_Gatecode_textbox="//input[@disabled='disabled' and @name='GateCode']";
	public static final String Property_Disabled_Lockbox_textbox="//input[@disabled='disabled' and @name='LockBox']";
	public static final String Property_Disabled_DueDate_xp="//input[@disabled='disabled' and @datepicker-popup='M/d/yyyy']";
	
	public static final String Property_PropertyWalk_ShowAllGroupsCheckbox_XP="//input[@type='checkbox'and@id='ShowAllGroups']";
	...
	public static final String Offices_AutoTestOffice_xp="//span[text()='AutoTestOffice' ]";
	public static final String Offices_CancelBTN_ID="cancelBtnRed";
	public static final String Offices_OfficeNameReplace_XP="//span[text()='officeNameReplace']";
	public static final String Offices_Advance_XP="//a[text()='Advanced']";
	public static final String Offices_Advance_addeditCheckbox_XP="//input[@id='disablePropertiesCheckbox']";
...
///by xpath
	public static final String Users_GenOffice_LinkOfficesOption_xp = "//a[text()= ' Users ']";
	public static final String Users_BtnAddItem_xp = "//button[@class='btn btn-orange ng-scope' and text()=' ADD USER']";
	public static final String USERS_SHOW_INACTIVE_CB_ID="showActiveCheck";
	
	public static final String USERS_SELECTOFFICE_COMBOBOX_XP="//*[contains(@id, 'filterList')]";
	public static final String USERS_SELECTOFC_OPTION_AUTOTESTOFFICE_XP="//option[text()='AutoTestOffice']";
	public static final String USERS_USERSLABEL_ID="pageTitle";
	public static final String USERS_CURRENTUSERS_LABEL_ID="tableTitle";
	public static final String USERS_SHOWINACTIVE_CHECKBOX_ID="showActiveCheck";
	public static final String USERS_CHECKACTIVERECORDS_XP="//div[./span[@title='Active']]";
	public static final String USERS_THDASSOCIATE_CHECKBOX_XP="//input[@type='checkbox' and @id='THDAssociate']";
	public static final String USERS_CANCEL_BTN_ID="cancelBtn";
	public static final String USERS_DISABLED_SAVE_BTN_XP="//button[@id='saveBtn' and @disabled='disabled']";
	public static final String USERS_USEREMAIL_LABEL_ID="UserEmailLabel";
	public static final String USERS_EMAIL_INPUT_XP="//input[@name='UserNameEmail']";
	public static final String USERS_FIRSTNAME_LABEL_ID="UserFirstNameLabel";
	public static final String USERS_FIRSTNAME_INPUT_XP="//input[@name='FirstName']";
	public static final String USERS_LASTNAME_LABEL_ID="UserLastNameLabel";
	public static final String USERS_LASTNAME_INPUT_XP="//input[@name='LastName']";
	public static final String USERS_SECURITYROLE_LABEL_ID="SecurityRoleLabel";
	public static final String USERS_SECURITYROLE_COMBOBOX_XP = "//select[@id='SecurityRole']";
	public static final String USERS_OFFICENAME_LABEL_ID="OfficeLabel";
	public static final String USERS_CORPORATION_LABEL_XP="//label[@id='CorporationMenuLabel']";
	public static final String USERS_CORPORATION_COMBOBOX_XP="//select[@name='CorporationMenu']";
	public static final String USERS_PHONENUMBER_LABEL_ID="PhoneNumberLabel";
	public static final String USERS_PHONENUMBER_INPUT_XP="//input[@name='PhoneNumber']";	
	public static final String USERS_ACTIVECHECKBOX_XP="//input[@name='Active']";
	public static final String USERS_LDAPID_LABEL_ID="LdapIdLabel";
	public static final String USERS_LDAP_INPUT_XP="//input[@name='UserNameLdap']";
	public static final String USERS_FIRSTNAME_READONLY_INPUT_XP="//input[@name='FirstName'and @readonly='readonly']";
	public static final String USERS_LASTNAME_READONLY_INPUT_XP="//input[@name='LastName'and @readonly='readonly']";
//	public static final String USERS_EMAIL_AUTOTEXT_TEXT="AutoTestEmail_"@text.com";
	public static final String USERS_SAVE_BTN_ID="saveBtn";
	public static final String USERS_OFFICES_BTN_NAME="Office";
	public static final String USERS_AUTOTESTOFFICE_FROM_COMBOBOX_XPATH="//span[contains(text(),'AutoTestOffice')]";
//	public static final String test="//tr[./td/b[text()='"+s+"']]//span[@title='Edit']";
	public static final String USERS_EDITUSER_XP="//tr[./td/b[text()='autoUserName']]//span[@title='Edit']";
	public static final String USERS_DELETEUSER_XP="//tr[./td/b[text()='userToBeDeleted']]//span[@title='Delete']";
...
///////////////////////////////////////User Objects end///////////////////////////////////////////////
	...
	////////////////////Utilities Objects starts////////////////////////////////////////
	
	// public static final String Utilities_GenProp_LinkUtilitiesOption_xp = "//a[text()= '  Utilities  ']";
	public static final String Utilities_GenProp_LinkUtilitiesOption_xp = "//*[@id='utilitiesSidebarBtn']/a";
	...
	//////////Utilities objects end///////////////////////////////////////////////////////
	
	///////////////////////Ipad versioning starts/////////////////////////////////
	//public static final String ipadVersioning_GenProp_LinkIpadVersioningOption_XP = "//a[text()= '   iPad Versioning   ']";
	public static final String ipadVersioning_GenProp_LinkIpadVersioningOption_XP = "//*[@id='ipadVersioningSidebarBtn']/a";
	public static final String IPADVERSIONING_POPUP_XP="//div[@class='dialog uibDialog ng-scope']";
	public static final String IPADVERSIONING_POPUP_LINKTO_IPADAPP_XP="//a[text()='this link']";
	public static final String IPADVERSIONING_POPUP_LOGOUT_BTN_XP="//button[text()='Log Out']";
	
	
	
	
	
	/////////////////////////////////Ipad versioning ends/////////////////////////////
