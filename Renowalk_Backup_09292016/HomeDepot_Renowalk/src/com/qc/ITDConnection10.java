...
public interface ITDConnection10 extends com.qc.ITDConnection9 {
  // Methods:
  /**
   * <p>
   * Set basic auth header mode
   * </p>
   * @param headerMode Mandatory com.qc.TDAPI_BASIC_AUTH_HEADER_MODES parameter.
   */

  @DISPID(223) //= 0xdf. The runtime will prefer the VTID if present
  @VTID(227)
  void setBasicAuthHeaderMode(
    com.qc.TDAPI_BASIC_AUTH_HEADER_MODES headerMode);
   ...
   * </p>
   * @param pSettings Mandatory com.qc.IConnectionSettings parameter.
   */

  @DISPID(224) //= 0xe0. The runtime will prefer the VTID if present
  @VTID(228)
  void importConnectionSettings(
    com.qc.IConnectionSettings pSettings);
