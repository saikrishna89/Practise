...
public interface ISupportAssetRelations2 extends com.qc.ISupportAssetRelations {
  // Methods:
  /**
   * <p>
   ...
   * @return  Returns a value of type com.qc.DEPENDENCIES_TYPE
   */

  @DISPID(6) //= 0x6. The runtime will prefer the VTID if present
  @VTID(12)
  com.qc.DEPENDENCIES_TYPE hasDependencies(
    boolean needRefresh);
