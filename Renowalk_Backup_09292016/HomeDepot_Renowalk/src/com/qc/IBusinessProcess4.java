...
public interface IBusinessProcess4 extends com.qc.IBusinessProcess3 {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @param testParamIdsList Mandatory com.qc.IList parameter.
   * @return  Returns a value of type com.qc.IList
   */

  @DISPID(135) //= 0x87. The runtime will prefer the VTID if present
  @VTID(83)
  com.qc.IList getBPIterParamsUsingTestParameters(
    com.qc.IList testParamIdsList);
