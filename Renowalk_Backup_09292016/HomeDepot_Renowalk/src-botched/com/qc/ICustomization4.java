...
public interface ICustomization4 extends com.qc.ICustomization3 {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @return  Returns a value of type com.qc.ICustomizationEntityAttributes
   */

  @DISPID(22) //= 0x16. The runtime will prefer the VTID if present
  @VTID(28)
  com.qc.ICustomizationEntityAttributes entityAttributes();
   ...
   * </p>
   * @return  Returns a value of type com.qc.ICustomizationRelations
   */

  @DISPID(23) //= 0x17. The runtime will prefer the VTID if present
  @VTID(29)
  com.qc.ICustomizationRelations relations();
  ...
  @VTID(31)
  com.qc.IList supportsMultivalueEntitiesTables();
  ...
  @VTID(32)
  com.qc.IList supportsQPMKPITypesEntitiesTables();
  ...
  @VTID(33)
  com.qc.IList supportsHistoryEntitiesTables();
  ...
  @VTID(34)
  com.qc.IList supportWorkflowEntitiesTables();
   ...
   * </p>
   * @return  Returns a value of type com.qc.ICustomizationUser
   */

  @DISPID(31) //= 0x1f. The runtime will prefer the VTID if present
  @VTID(37)
  com.qc.ICustomizationUser loggedInUser();
  ...
  @VTID(38)
  com.qc.IList supportsDataHidingFilterEntitiesTables();
