...
public interface IConnectionSettings extends Com4jObject {
  ...
  @VTID(12)
  void clientCert(
    @MarshalAs(NativeType.VARIANT) java.lang.Object pCertContext);
   ...
   * </p>
   * @param pExecutionMode Mandatory com.qc.TDAPI_EXECUTION_MODES parameter.
   */

  @DISPID(7) //= 0x7. The runtime will prefer the VTID if present
  @VTID(14)
  void executionMode(
    com.qc.TDAPI_EXECUTION_MODES pExecutionMode);
   ...
   * </p>
   * @return  Returns a value of type com.qc.TDAPI_EXECUTION_MODES
   */

  @DISPID(7) //= 0x7. The runtime will prefer the VTID if present
  @VTID(15)
  com.qc.TDAPI_EXECUTION_MODES executionMode();
   ...
   * </p>
   * @param pForceAuthHeader Mandatory com.qc.TDAPI_BASIC_AUTH_HEADER_MODES parameter.
   */

  @DISPID(8) //= 0x8. The runtime will prefer the VTID if present
  @VTID(16)
  void basicAuthHeaderMode(
    com.qc.TDAPI_BASIC_AUTH_HEADER_MODES pForceAuthHeader);
   ...
   * </p>
   * @return  Returns a value of type com.qc.TDAPI_BASIC_AUTH_HEADER_MODES
   */

  @DISPID(8) //= 0x8. The runtime will prefer the VTID if present
  @VTID(17)
  com.qc.TDAPI_BASIC_AUTH_HEADER_MODES basicAuthHeaderMode();
  ...
  void setCurrentCertificateKeys(
    @MarshalAs(NativeType.VARIANT) java.lang.Object certSN,
    @MarshalAs(NativeType.VARIANT) java.lang.Object certIss);
  ...
  void getCurrentCertificateKeys(
    java.lang.Object pCertSN,
    java.lang.Object pCertIss);
   ...
   * Get copy object
   * </p>
   * @return  Returns a value of type com.qc.IConnectionSettings
   */

  @DISPID(12) //= 0xc. The runtime will prefer the VTID if present
  @VTID(22)
  com.qc.IConnectionSettings cloneTo();
