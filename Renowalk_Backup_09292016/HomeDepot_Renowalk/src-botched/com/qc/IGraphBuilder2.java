...
public interface IGraphBuilder2 extends com.qc.IGraphBuilder {
  // Methods:
  /**
   * <p>
   ...
   * Build the graph.
   * </p>
   * @param pGraphDef Mandatory com.qc.IGraphDefinition parameter.
  ...
  java.lang.String startBuildGraph(
    com.qc.IGraphDefinition pGraphDef);
   ...
   * @param pGraphDef Mandatory com.qc.IGraphDefinition parameter.
   * @return  Returns a value of type com.qc.IGraph
   */

  @DISPID(6) //= 0x6. The runtime will prefer the VTID if present
  @VTID(12)
  com.qc.IGraph getGraphResultFromString(
