...
public interface ISysTreeNode extends Com4jObject {
   ...
   * @return  Returns a value of type com.qc.ISysTreeNode
   */

  @DISPID(1) //= 0x1. The runtime will prefer the VTID if present
  @VTID(9)
  com.qc.ISysTreeNode addNode(
  ...
  @VTID(13)
  com.qc.ISysTreeNode findChildNode(
