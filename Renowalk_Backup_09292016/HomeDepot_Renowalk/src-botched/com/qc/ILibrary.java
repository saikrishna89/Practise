...
public interface ILibrary extends com.qc.IBaseFieldExMail {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @param srcLibrary Mandatory com.qc.ILibraryInfo parameter.
   * @param srcBaselineId Mandatory int parameter.
   * @param comparisonId Mandatory int parameter.
   * @param fieldsToSync Mandatory com.qc.IList parameter.
   * @return  Returns a value of type int
   */
  ...
  @VTID(33)
  int beginSync(
    com.qc.ILibraryInfo srcLibrary,
    int srcBaselineId,
    int comparisonId,
    com.qc.IList fieldsToSync);
   ...
   * </p>
   * @return  Returns a value of type com.qc.ILibraryOperationResult
   */

  @DISPID(33) //= 0x21. The runtime will prefer the VTID if present
  @VTID(35)
  com.qc.ILibraryOperationResult createBaselineVerification();
  ...
  @VTID(36)
  com.qc.ILibraryOperationResult syncLibrariesVerification(
    com.qc.ILibraryInfo srcLibrary,
    int srcBaselineId,
    int comparisonId);
