...
public interface IBaseField2 extends Com4jObject {
   ...
   * @return  Returns a value of type com.qc.IMultiValue
   */

  @DISPID(2) //= 0x2. The runtime will prefer the VTID if present
  @VTID(9)
  com.qc.IMultiValue fieldMultiValue(
   ...
   * </p>
   * @param fieldName Mandatory java.lang.String parameter.
   * @param pMultiValue Mandatory com.qc.IMultiValue parameter.
   */
  ...
  void fieldMultiValue(
    java.lang.String fieldName,
    com.qc.IMultiValue pMultiValue);
